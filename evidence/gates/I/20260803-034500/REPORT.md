# Gate I Run Report - 20260803-034500
...
- **Scope**: 会话版本内容图 — fixture-only 证据，不访问真实 TRAE 数据
...
## Test Summary
- ``classify-identical``
- ``classify-fast-forward``
- ``classify-forked-modification``
- ``classify-forked-deletion``
- ``classify-forked-reorder``
- ``classify-forked-two-sided``
- ``classify-unclassified``
- ``hash-deterministic-order``
- ``hash-excludes-soft-deleted``
- ``unclassified-preserves-old``
