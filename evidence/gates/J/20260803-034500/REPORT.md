# Gate J Run Report - 20260803-034500
...
- **Scope**: 软删除语义 — fixture-only 证据，不访问真实 TRAE 数据
...
## Test Summary
- ``soft-deleted-retained-excluded``
- ``browse-excludes-soft-deleted``
- ``diagnostic-integrity-counts``
- ``read-messages-marks-soft-deleted``
- ``read-sessions-marks-soft-deleted``
- ``read-projects-excludes-soft-deleted``
